...
function EditProStudent() {
  ...
  const submit = () => {
    if (Firstname == "") {
      ...
      axios
        .put("http://44.203.0.129:8989/api/user/update", data)
        .then((res) => {
  ...
  const getuserbyid = () => {
    console.log("check");
    axios
      .get("http://44.203.0.129:8989/api/user/get/" + setLearnerid)
      .then((res) => {
  ...
  return (
    <>
      ...
      <main
        id="main"
        class="create-course-wrapper data-img tp-page sticked-header-offset"
      >
        <section id="create-course" class="create-course pt-large">
          <div class="container aos_init aos-animate">
            <div class="row gy-5 align-items-center create-course-banner-wrap">
              <div
                class="col-lg-6 d-flex flex-column res-mt justify-content-center relative text-center text-lg-start"
                data-aos="fade-up"
                ...
                <div class="create-course-inner bg-white position-relative">
                  <form action="#" class="create-course-form">
                    ...
                    <div class="form-group">
                      <input
                        type="text"
                        onChange={(e) => setPhoenum(e.target.value)}
                        class="form-control"
                    ...
                    <div class="form-group">
                      <label class="uploadd uploading uploadingtext">
                        Profile Image
                      </label>
                      <input
                        type="file"
                        onChange={(e) => contentimage64(e.target.files[0])}
                        name="fileupload"
                        id="fileupload"
              ...
              <div
                class="col-lg-6 text-center ps-lg-5"
                data-aos="fade-down"
                data-aos-easing="ease-out-cubic"
                data-aos-duration="1000"
              >
